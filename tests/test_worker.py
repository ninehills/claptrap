...
from claptrap import (get_failed_queue, Queue, SimpleWorker, Worker,
                      get_current_connection)
from claptrap.compat import as_text, PY2
from claptrap.job import Job, JobStatus
from claptrap.registry import StartedJobRegistry
from claptrap.suspension import resume, suspend
from claptrap.utils import utcnow
from claptrap.worker import HerokuWorker
...
class TestWorker(RQTestCase):
    ...
    def test_cancelled_jobs_arent_executed(self):  # noqa
        ...
        SENTINEL_FILE = '/tmp/claptrap-tests.txt'
...
class TestWorkerSubprocess(RQTestCase):
    ...
    def test_run_empty_queue(self):
        ...
        subprocess.check_call(['claptrap', 'worker', '-u', self.redis_url, '-b'])
