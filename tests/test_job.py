...
from claptrap.compat import PY2, as_text
from claptrap.exceptions import NoSuchJobError, UnpickleError
from claptrap.job import Job, get_current_job, JobStatus, cancel_job
from claptrap.queue import Queue, get_failed_queue
from claptrap.registry import DeferredJobRegistry
from claptrap.utils import utcformat
from claptrap.worker import Worker
...
class TestJob(RQTestCase):
    ...
    def test_fetch(self):
        """Fetching jobs."""
        # Prepare test
        self.testconn.hset('claptrap:job:some_id', 'data',
                           "(S'tests.fixtures.some_calculation'\nN(I3\nI4\nt(dp1\nS'z'\nI2\nstp2\n.")
        self.testconn.hset('claptrap:job:some_id', 'created_at',
    ...
    def test_register_dependency(self):
        ...
        self.assertEqual(as_text(self.testconn.spop('claptrap:job:id:dependents')), job.id)
