...
from claptrap import get_failed_queue, Queue
from claptrap.exceptions import InvalidJobDependency, InvalidJobOperationError
from claptrap.job import Job, JobStatus
...
class TestQueue(RQTestCase):
    ...
    def test_empty_queue(self):
        ...
        self.testconn.rpush('claptrap:queue:example', 'foo')
        self.testconn.rpush('claptrap:queue:example', 'bar')
        self.assertEqual(q.is_empty(), False)

        q.empty()

        self.assertEqual(q.is_empty(), True)
        self.assertIsNone(self.testconn.lpop('claptrap:queue:example'))
    ...
    def test_queue_is_empty(self):
        ...
        self.testconn.rpush('claptrap:queue:example', 'sentinel message')
        self.assertEqual(q.is_empty(), False)
