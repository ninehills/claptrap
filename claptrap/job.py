...
from claptrap.compat import as_text, decode_redis_hash, string_types, text_type
...
class Job(object):
    ...
    def key_for(cls, job_id):
        ...
        return b'claptrap:job:' + job_id.encode('utf-8')

    @classmethod
    def dependents_key_for(cls, job_id):
        """The Redis key that is used to store job hash under."""
        return 'claptrap:job:{0}:dependents'.format(job_id)
    ...
    def register_dependency(self, pipeline=None):
        ...
        like:
            ...
            claptrap:job:job_id:dependents = {'job_id_1', 'job_id_2'}
