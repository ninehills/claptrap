...
class Queue(object):
    ...
    redis_queue_namespace_prefix = 'claptrap:queue:'
    redis_queues_keys = 'claptrap:queues'
    ...
    def compact(self):
        ...
        """
        COMPACT_QUEUE = 'claptrap:queue:_compact:{0}'.format(uuid.uuid4())
